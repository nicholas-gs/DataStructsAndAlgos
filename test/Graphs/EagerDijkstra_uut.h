...
#include "../../include/Graphs/EagerDijkstra.h"

TEST_CASE("Eager Dijkstra's Algorithm on directed graph (1)") {
    ...
    SECTION("Getting shortest path between 2 vertices that exists (1)") {
        ...
        wtl::EagerDijkstra dijkstra(graph, 0);
    ...
    SECTION("Getting shortest path between 2 vertices that exists (2)") {
        ...
        refSP.emplace_back(2, 1, 3);
        wtl::EagerDijkstra dijkstra(graph, 3);
    ...
    SECTION("Getting shortest path between 2 vertices that don't exist") {
        wtl::EagerDijkstra dijkstra(graph, 1);
        REQUIRE_THROWS(dijkstra.pathTo(0));
    }

}

TEST_CASE("Eager Dijkstra's Algorithm on directed graph (2)") {
    ...
    SECTION("Getting shortest path between 2 vertices that exists (1)") {
        ...
        wtl::EagerDijkstra dijkstra(graph, 4);
        std::vector<Edge> result = dijkstra.pathTo(3);
        REQUIRE(result == refSP);
        REQUIRE(dijkstra.distanceTo(3) == 8);
    }
    ...
    SECTION("Getting shortest path between 2 vertices that exists (2)") {
        ...
        wtl::EagerDijkstra dijkstra(graph, 4);
        std::vector<Edge> result = dijkstra.pathTo(6);
        REQUIRE(refSP == result);
        REQUIRE(dijkstra.distanceTo(6) == 16);
    }
