...
#include "../catch.hpp"
#include "../../include/FlowNetworks/EdmondsKarp.h"

TEST_CASE("Edmonds-Karp on flow network (1)") {
...
TEST_CASE("Edmonds-Karp on flow network (2)") {
    ...
    wtl::EdmondsKarp edmondsKarp(flowNetwork, 0, 10);
    REQUIRE(edmondsKarp.getMaxFlow() == 7);
