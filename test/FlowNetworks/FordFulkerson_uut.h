...
#include "../catch.hpp"
#include "../../include/FlowNetworks/FordFulkerson.h"

TEST_CASE("Ford-Fulkerson on flow network (1)") {
...
TEST_CASE("Ford-Fulkerson on flow network (2)") {
    ...
    wtl::FordFulkerson ff(flowNetwork, 0, 10);
    REQUIRE(ff.getMaxFlow() == 7);
